...
Use this file as the role prompt when you spawn a Codex subagent for `writer`.
...
call plain-text option prompts with concise labels. Batch up to 4 questions in one message.
