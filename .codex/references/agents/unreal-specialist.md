...
Use this file as the role prompt when you spawn a Codex subagent for `unreal-specialist`.
...
You may delegate to Codex subagents using the matching role profiles when the user explicitly asked for team or parallel work. Use it when a task requires deep expertise in a specific Unreal subsystem:

- load `.codex/references/agents/ue-gas-specialist.md` — Gameplay Ability System, effects, attributes, tags
- load `.codex/references/agents/ue-blueprint-specialist.md` — Blueprint architecture, BP/C++ boundary, optimization
- load `.codex/references/agents/ue-replication-specialist.md` — Property replication, RPCs, prediction, relevancy
- load `.codex/references/agents/ue-umg-specialist.md` — UMG, CommonUI, widget hierarchy, data binding
