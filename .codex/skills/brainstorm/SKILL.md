...
Synced from `.claude/skills/brainstorm/SKILL.md`.

## Codex Notes

- Invoke this workflow with `$brainstorm`.
...
3. **Run through ideation phases** interactively, asking the user questions at
   ...
   **Use plain-text option prompts** at key decision points throughout brainstorming:
   ...
   plain-text option prompts to capture the decision with concise labels.
