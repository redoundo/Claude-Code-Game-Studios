...
Synced from `.claude/skills/team-level/SKILL.md`.

## Codex Notes

- Invoke this workflow with `$team-level`.
...
- load `.codex/references/agents/narrative-director.md` — Narrative purpose, characters, emotional arc
- load `.codex/references/agents/world-builder.md` — Lore context, environmental storytelling, world rules
- load `.codex/references/agents/level-designer.md` — Spatial layout, pacing, encounters, navigation
- load `.codex/references/agents/systems-designer.md` — Enemy compositions, loot tables, difficulty balance
- load `.codex/references/agents/art-director.md` — Visual theme, color palette, lighting, asset requirements
- load `.codex/references/agents/qa-tester.md` — Test cases, boundary testing, playtest checklist
