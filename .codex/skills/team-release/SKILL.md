...
Synced from `.claude/skills/team-release/SKILL.md`.

## Codex Notes

- Invoke this workflow with `$team-release`.
...
- load `.codex/references/agents/release-manager.md` — Release branch, versioning, changelog, deployment
- load `.codex/references/agents/qa-lead.md` — Test sign-off, regression suite, release quality gate
- load `.codex/references/agents/devops-engineer.md` — Build pipeline, artifacts, deployment automation
- load `.codex/references/agents/producer.md` — Go/no-go decision, stakeholder communication
