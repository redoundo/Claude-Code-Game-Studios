...
Synced from `.claude/skills/map-systems/SKILL.md`.

## Codex Notes

- Invoke this workflow with `$map-systems`.
...
- Use plain-text option prompts to ask:
...
Then use plain-text option prompts to capture feedback:
...
Use plain-text option prompts to ask: "Does this dependency ordering look right? Any
...
Use plain-text option prompts to ask: "Do these priority assignments match your vision?
...
Use plain-text option prompts for: "Start designing [system-name] now, pick a different
system, or stop here?"
...
After `$design-system` completes, use plain-text option prompts:
